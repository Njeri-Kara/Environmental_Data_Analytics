...
\begin{quote}
Answer: Reproducible data analysis ensures that someone can later
produce the same outcomes from the same data and analysis. It is an
accountability measure and it allows data scientists to review their
analysis process at a later time and get the same result.
\end{quote}
...
\begin{quote}
Answer: My experience with R is in the Applied Statitics course (ENV
710) I took in fall 2018. I have no prior expereince with Git
\end{quote}
